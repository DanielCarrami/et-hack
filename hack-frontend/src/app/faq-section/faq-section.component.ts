...
export class FaqSectionComponent implements OnInit {
  ...
  lista=[
    ...
    {pregunta: "¿Como puedo registrarme?", respuesta: "Haga clic en el botón 'Registro' que se encuentra arriba y completa el formulario.", open: false},
    {pregunta: "¿Quien puede participar?", respuesta: "Todo aquel que sea actualmente un estudiante registrado en el periodo Enero-Junio 2021 de cualquier campus del Tecnológico de Monterrey, tanto de carreras profesionales como de programas de preparatoria.", open: false}, 
    {pregunta: "¿Como se llevará a cabo este hackathon?", respuesta: "Este año, para garantizar la seguridad de nuestros participantes y cumplir con las políticas gubernamentales y universitarias, el hackathon se llevará a cabo virtualmente a través de Discord por lo que lxs asistentes podrán unirse desde cualquier punto de México.", open: false},
    {pregunta: "¿Que tan grandes pueden ser los equipos?", respuesta: "No pueden haber más de 5 personas en un equipo", open: false}, 
    ...
    {pregunta: "¿Qué puedo crear?", respuesta: "Web, móvil, hardware, ¡lo que sea! Los proyectos serán evaluados en función de la creatividad, viabilidad de implementación, diseño y la utilidad por un panel de jueces de la industria. ", open: false}
  ];
