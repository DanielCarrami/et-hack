...
export class FaqSectionComponent implements OnInit {
  ...
  lista=[
    {pregunta: "¿Qué es Et-Hack?", respuesta: "Et-Hack es un hackathon de 36 horas totalmente en línea y centrado en la problemática medioambiental. Es un hackathon nacional para estudiantes universitarios y de preparatoria, organizado por estudiantes del Tecnológico de Monterrey Campus Puebla. ¡Este año, nos volvemos digitales! ¡Conoce a diseñadores, desarrolladores y entusiastas de la tecnología y sustentabilidad, forma equipo con ellos y desarrolla proyectos creativos con un enfoque en la transformación de espacios sustentables!", open: false},
    ...
    {pregunta: "¿Qué tan grandes pueden ser los equipos?", respuesta: "Cada equipo está conformado de 5 hackers. ¡No te olvides de incluir distintos perfiles en tu equipo! La diversidad (de género, carreras e ideas) rompe fronteras.", open: false}, 
